...
import { MatAutocompleteModule,MatSort,MatPaginator,MatPaginatorIntl} from '@angular/material';
...
@Component({
  ...
  styleUrls: ['./global-discount.component.scss'],
...
export class EditDiscount {
  ...
  pro=true;
  constructor(
    public dialogRef: MatDialogRef<EditDiscount>,
