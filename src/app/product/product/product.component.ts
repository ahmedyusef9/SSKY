...
import { MatDialog, MAT_DIALOG_DATA, MatDialogRef, MatSnackBar, MatSort, MatPaginator, MatPaginatorIntl } from '@angular/material';
...
export class ProductComponent implements OnInit {
  ...
  constructor(
      ...
      private router:Router,private mdPaginatorIntl:MatPaginatorIntl,
